...
Page({
	...
	onLoad: function() {
		...
		//首页幻灯片
		wx.request({
			url: app.globalData.baseUrl + '/mallPort/home/content',
			method: 'GET',
      header: {
        'content-type': 'application/x-www-form-urlencoded'
			...
			success: function(res) {
				if (res.data.code == 200) {
					//console.log(res.data.data['hotProductList']);
					that.setData({
						banners: res.data.data['advertiseList'],
						//sales: res.data.data['brandList'],
						hot: res.data.data['brandList'],
						topgoods: res.data.data['hotProductList']
					});
				}
			}
		})
		//4个功能展示位
		// wx.request({
		//   url: app.globalData.baseUrl + '/home/content',
		//   data: {
		//     key: 'mallName',
		//     type: 'sale'
		//   },
